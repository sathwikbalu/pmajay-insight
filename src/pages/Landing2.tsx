          ...
          >
            {schemeGoals.map((goal, index) => (
              ...
              >
                ...
                <p className="text-foreground">{t(goal)}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
              ...
              >
                <Card className="relative overflow-hidden bg-card/50 backdrop-blur-md border-border/50 shadow-card hover:shadow-elegant transition-all duration-300">
                  ...
                  <CardContent className="p-6 text-center relative z-10">
                    <div
                      className={`w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-${stat.color} flex items-center justify-center shadow-lg`}
                    >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link
                    to="/modules/beneficiary-form"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    {t("sidebar.beneficiaryForm")}
                  </Link>
                </li>
                <li>
                  <Link
                    to="/modules/grievance"
                    className="text-muted-foreground hover:text-primary transition-colors"
                  >
                    {t("sidebar.grievance")}
                  </Link>
